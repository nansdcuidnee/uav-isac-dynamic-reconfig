...
def train_maddpg_isac_3drone():
    """
    训练MADDPG-ISAC算法（3个无人机）- 修复版
    """
    # 环境参数
    num_drones = 3
    num_users = 20
    ...
    # 创建保存目录
    save_dir = "results/drone_number/exp3_num_uav_3_isac"
    ...
    plt.title('Reward Curve (MADDPG-ISAC)')
    plt.xlabel('Episode')
    ...
    plt.title('Coverage Curve (MADDPG-ISAC)')
    plt.xlabel('Episode')
    ...
    plt.title('Loss Curve (MADDPG-ISAC)')
    plt.xlabel('Episode')
